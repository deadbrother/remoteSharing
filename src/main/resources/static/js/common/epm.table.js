...
(function($) {
  ...
  var getPagiTools = function(pagi) {
    var isFirstPage = (pagi.currentPageNum == 1 || pagi.totalPageNum == 0);//当总页数为0时的特殊处理
    var isLastPage = (pagi.currentPageNum == pagi.totalPageNum || pagi.totalPageNum == 0);
    return '\
      <nav>\
        <ul class="pager pager-theme">\
          ...
          <li>\
            <input class="currentPageNum form-control input-sm" type="text" value="' + (pagi.totalPageNum == 0 ? 0 : pagi.currentPageNum) + '" data-total-page-num="' + pagi.totalPageNum + '"/>/' + pagi.totalPageNum + '页\
          </li>\
          <li>\
