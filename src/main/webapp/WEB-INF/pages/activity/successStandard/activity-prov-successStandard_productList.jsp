...
<div id="successListDiv" style="width: 99.97%; margin-top: 5px;margin-bottom: 0px;"
		...
		<table width="100%" id="tools-demo-table-left" style="margin-bottom: 0px;" class="slds-table slds-table--bordered slds-table--fixed-layout " data-epm="selectable-table" role="grid">
				<thead>
					<tr>
						<th width="10%" >
				 ...
				 <tbody id="traversal" class="hidden" data-traversal-url="${pageContext.request.contextPath}/clyx/activity/activity-prov!querySuccessProductList.action" data-traversal-prompt='{"empty":"<tr><td colspan=\"${fn:length(propertyState) + 10}\" style=\"color:orange\">暂无相关的产品信息</td></tr>"}'>
					<tr >
