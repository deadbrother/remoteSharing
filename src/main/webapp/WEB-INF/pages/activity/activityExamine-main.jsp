...
<script src="${pageContext.request.contextPath}/js/activity/activityExamine-main.js" type="text/javascript"></script>
 ...
 <div id="form2" class="container" style="margin-top:40px;width:100%;margin-left: 50px">
		<div class="slds-form-element" >
		   ...
		   <button  id="search-tool-btn" class="slds-button slds-button--brand slds-size--2-of-16" style="margin-left: 60%">
			...
			<button  id="examinebutton" class="slds-button slds-button--brand slds-size--2-of-16">
				<span style="color:white" class="epm-icon glyphicon glyphicon-check"></span>&nbsp;审批
			</button>
			
			
	</div>
<div class="slds-container--left slds-p-horizontal--small" style="width:100%;margin-top: 35px;">
	<div id="examineidmain"></div>
</div>
