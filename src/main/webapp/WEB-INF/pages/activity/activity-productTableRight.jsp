...
<script src="../js/activity/productTableRight.js" type="text/javascript"></script> 
...
<div class="container">
<div cklass="row">
<table  style="border-collapse:separate;display:table-cell;table-layout:fixed;">
	<tr>
 		<td width="15%" style="font-size: 15px;color: #16325C;text-align: right">
           名称/编码:
 		</td>
 		<td width="15%">
 			<input class="slds-input" id="queryRightVal" type="text" placeholder="请输入产品编码或产品名称"/>
 		</td>
		...
		<td width="10%">
			<button id="queryRight" type="button" onclick="window.parent.refreshDown();" class="slds-button slds-button--brand" style="margin-left: 10px">查询</button>
		</td>
		<td width="10%">
			<button id="deleteDownPro" type="button" onclick="deleteDownPro();" class="slds-button slds-button--brand" style="margin-left: 10px">删除</button>
		</td>
 		</tr>
 		<tr>
...
<div class="slds-container--left slds-p-horizontal--small" style="width:88%;margin-top:10px">
	<div id="maingridDown" class=""></div>
</div>
