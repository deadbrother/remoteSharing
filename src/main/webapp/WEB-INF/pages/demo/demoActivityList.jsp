...
form成功
<form action="demoSave" style="margin-left:50px;">
	<input name="activityId"  value="${demopo.activityId}" /><br>
	<input name="activityName" value="${demopo.activityName}" /><br>
	<input name="startDate" value="${demopo.startDate}" /></br>
