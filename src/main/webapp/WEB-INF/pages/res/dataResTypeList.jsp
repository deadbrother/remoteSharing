...
<title>数据源类型</title>
	...
	<script src="${pageContext.request.contextPath}/js/wxwl/res/dataResType.js" type="text/javascript"></script>
	<script>
	$(function (){
		$("#form1").ligerForm();
	});
...
<div class="container" id="form1">
	<table class="slds-table">
		<tr>
			<td><label for="dataId" class="slds-form-element__label">类型名称：</label></td>
			<td><input id="data_res_type_name" type="text" class="ui-textbox"/></td>
			<td><label for="res_type" class="slds-form-element__label">数据源：</label></td>
			<td>
				 <select id="res_type" >
			...
			<td><label for="data_stutas" class="slds-form-element__label">数据源：</label></td>
			<td>
