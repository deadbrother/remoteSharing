...
<script src="${pageContext.request.contextPath}/js/wxwl/res/entityField.js" type="text/javascript"></script>
...
<div class="container">
		<div align="right"><a href="/epmwxwl/entity/list">返回上一级</a></div>
        <div id="layout1">
             <div  position="left">
             <div id="form1">
	            	<table>
		            	<tr>
							...
							<td>
								<input id="field_name" type="text" class="ui-textbox" >
							...
							<td>
								<select id="field_type">
								 ...
								 <option  value="${li.field_type_id}">${li.field_type_name}</option>
								 </c:forEach>
								</select>
							</td>
